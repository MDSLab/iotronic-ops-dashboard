...
class CreateServiceLink(tables.LinkAction):
    ...
    url = "horizon:admin:services:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditBoardLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:admin:services:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class RemoveServicesLink(tables.LinkAction):
    ...
    url = "horizon:admin:services:remove"
    classes = ("ajax-modal",)
    icon = "plus"
...
class ActionServiceLink(tables.LinkAction):
    ...
    url = "horizon:admin:services:action"
    classes = ("ajax-modal",)
    # icon = "plus"
...
class ServicesTable(tables.DataTable):
    name = tables.WrappingColumn('name', link="horizon:admin:services:detail",
