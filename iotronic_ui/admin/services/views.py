...
from openstack_dashboard.dashboards.admin.services \
...
class CreateView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy("horizon:admin:services:create")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:admin:services:update"
    success_url = reverse_lazy('horizon:admin:services:index')
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse("horizon:admin:services:index")
            exceptions.handle(self.request,
...
class ActionView(forms.ModalFormView):
    template_name = 'admin/services/action.html'
    ...
    # submit_url = reverse_lazy("horizon:admin:services:action")
    submit_url = "horizon:admin:services:action"
    success_url = reverse_lazy('horizon:admin:services:index')
...
class RemoveServicesView(forms.ModalFormView):
    template_name = 'admin/services/remove.html'
    ...
    submit_url = "horizon:admin:services:remove"
    success_url = reverse_lazy('horizon:admin:services:index')
...
class ServiceDetailView(DetailView):
    redirect_url = 'horizon:admin:services:index'
