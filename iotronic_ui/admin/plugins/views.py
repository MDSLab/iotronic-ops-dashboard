...
from openstack_dashboard.dashboards.admin.plugins import forms as project_forms
from openstack_dashboard.dashboards.admin.plugins \
    import tables as project_tables
from openstack_dashboard.dashboards.admin.plugins import tabs as project_tabs
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'admin/plugins/index.html'
...
class CreateView(forms.ModalFormView):
    template_name = 'admin/plugins/create.html'
    ...
    submit_url = reverse_lazy("horizon:admin:plugins:create")
    success_url = reverse_lazy('horizon:admin:plugins:index')
    page_title = _("Create Plugin")


class InjectView(forms.ModalFormView):
    template_name = 'admin/plugins/inject.html'
    ...
    # submit_url = reverse_lazy("horizon:admin:plugins:inject")
    submit_url = "horizon:admin:plugins:inject"
    success_url = reverse_lazy('horizon:admin:plugins:index')
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse("horizon:admin:plugins:index")
            exceptions.handle(self.request,
...
class StartView(forms.ModalFormView):
    template_name = 'admin/plugins/start.html'
    modal_header = _("Start Plugin")
    form_id = "start_plugin_form"
    form_class = project_forms.StartPluginForm
    submit_label = _("Start Plugin")
    # submit_url = reverse_lazy("horizon:admin:plugins:start")
    submit_url = "horizon:admin:plugins:start"
    success_url = reverse_lazy('horizon:admin:plugins:index')
...
class StopView(forms.ModalFormView):
    template_name = 'admin/plugins/stop.html'
    modal_header = _("Stop Plugin")
    form_id = "stop_plugin_form"
    form_class = project_forms.StopPluginForm
    submit_label = _("Stop Plugin")
    # submit_url = reverse_lazy("horizon:admin:plugins:stop")
    submit_url = "horizon:admin:plugins:stop"
    success_url = reverse_lazy('horizon:admin:plugins:index')
...
class CallView(forms.ModalFormView):
    template_name = 'admin/plugins/call.html'
    modal_header = _("Call Plugin")
    form_id = "call_plugin_form"
    form_class = project_forms.CallPluginForm
    submit_label = _("Call Plugin")
    # submit_url = reverse_lazy("horizon:admin:plugins:call")
    submit_url = "horizon:admin:plugins:call"
    success_url = reverse_lazy('horizon:admin:plugins:index')
...
class RemoveView(forms.ModalFormView):
    template_name = 'admin/plugins/remove.html'
    ...
    # submit_url = reverse_lazy("horizon:admin:plugins:remove")
    submit_url = "horizon:admin:plugins:remove"
    success_url = reverse_lazy('horizon:admin:plugins:index')
...
class UpdateView(forms.ModalFormView):
    template_name = 'admin/plugins/update.html'
    ...
    submit_url = "horizon:admin:plugins:update"
    success_url = reverse_lazy('horizon:admin:plugins:index')
...
class PluginDetailView(DetailView):
    redirect_url = 'horizon:admin:plugins:index'
