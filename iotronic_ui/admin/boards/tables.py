...
class CreateBoardLink(tables.LinkAction):
    ...
    url = "horizon:admin:boards:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditBoardLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:admin:boards:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class RemovePluginsLink(tables.LinkAction):
    ...
    url = "horizon:admin:boards:removeplugins"
    classes = ("ajax-modal",)
    icon = "plus"
    # policy_rules = (("iot", "iot:create_board"),)
...
def show_services(board_info):
    template_name = 'admin/boards/_cell_services.html'
...
class BoardsTable(tables.DataTable):
    name = tables.WrappingColumn('name', link="horizon:admin:boards:detail",
