...
from openstack_dashboard.dashboards.project.plugins \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'project/plugins/index.html'
...
class CreateView(forms.ModalFormView):
    template_name = 'project/plugins/create.html'
    ...
    submit_url = reverse_lazy("horizon:project:plugins:create")
    success_url = reverse_lazy('horizon:project:plugins:index')
    page_title = _("Create Plugin")


class InjectView(forms.ModalFormView):
    template_name = 'project/plugins/inject.html'
    ...
    # submit_url = reverse_lazy("horizon:project:plugins:inject")
    submit_url = "horizon:project:plugins:inject"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class StartView(forms.ModalFormView):
    template_name = 'project/plugins/start.html'
    modal_header = _("Start Plugin")
    form_id = "start_plugin_form"
    form_class = project_forms.StartPluginForm
    submit_label = _("Start Plugin")
    # submit_url = reverse_lazy("horizon:project:plugins:start")
    submit_url = "horizon:project:plugins:start"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class StopView(forms.ModalFormView):
    template_name = 'project/plugins/stop.html'
    modal_header = _("Stop Plugin")
    form_id = "stop_plugin_form"
    form_class = project_forms.StopPluginForm
    submit_label = _("Stop Plugin")
    # submit_url = reverse_lazy("horizon:project:plugins:stop")
    submit_url = "horizon:project:plugins:stop"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class CallView(forms.ModalFormView):
    template_name = 'project/plugins/call.html'
    modal_header = _("Call Plugin")
    form_id = "call_plugin_form"
    form_class = project_forms.CallPluginForm
    submit_label = _("Call Plugin")
    # submit_url = reverse_lazy("horizon:project:plugins:call")
    submit_url = "horizon:project:plugins:call"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class RemoveView(forms.ModalFormView):
    template_name = 'project/plugins/remove.html'
    ...
    # submit_url = reverse_lazy("horizon:project:plugins:remove")
    submit_url = "horizon:project:plugins:remove"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class UpdateView(forms.ModalFormView):
    template_name = 'project/plugins/update.html'
    ...
    submit_url = "horizon:project:plugins:update"
    success_url = reverse_lazy('horizon:project:plugins:index')
...
class PluginDetailView(DetailView):
    redirect_url = 'horizon:project:plugins:index'
