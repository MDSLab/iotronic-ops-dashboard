...
class EditBoardLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:project:services:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class RemoveServicesLink(tables.LinkAction):
    ...
    url = "horizon:project:services:remove"
    classes = ("ajax-modal",)
    icon = "plus"
...
class ActionServiceLink(tables.LinkAction):
    ...
    url = "horizon:project:services:action"
    classes = ("ajax-modal",)
    # icon = "plus"
...
class ServicesTable(tables.DataTable):
    name = tables.WrappingColumn('name', link="horizon:project:services:detail",
