...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("project/boards/_detail_overview.html")

    def get_context_data(self, request):
        # LOG.debug("MELO KWARGS: %s",
        #           self.tab_group.kwargs['board']._info['code'])
        # board_location = self.tab_group.kwargs['board']._info['location']
